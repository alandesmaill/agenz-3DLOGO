...
export default function LoadingScreen({ progress, isLoaded }: LoadingScreenProps) {
  ...
  return (
    <div
      ...
      style={{
        background: 'radial-gradient(ellipse 70% 60% at 20% 50%, rgba(0, 255, 255, 0.08) 0%, transparent 55%), radial-gradient(ellipse 60% 50% at 60% 85%, rgba(0, 255, 255, 0.06) 0%, transparent 55%), #0d0d0d',
        opacity,
